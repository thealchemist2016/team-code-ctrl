...
- Name: release.spec.js >> Release Management & User Operations (Tiers 1-4) >> T2-16: Click play on a track opens it in persistent bottom player
- Location: tests\release.spec.js:310:3
...
Call log:
  ...
  - waiting for locator('#btn-play')
    14 × locator resolved to <button id="btn-play">Play</button>
