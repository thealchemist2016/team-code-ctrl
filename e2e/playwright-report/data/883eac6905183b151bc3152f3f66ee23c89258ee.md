...
- Name: release.spec.js >> Release Management & User Operations (Tiers 1-4) >> T2-14: Click "Pending Releases" count navigates to pending list
- Location: tests\release.spec.js:297:3
...
Expected pattern: /.*releases\/pending/
...
Call log:
  - Expect "toHaveURL" with timeout 5000ms
    ...
    - waiting for" http://localhost:3000/releases/pending" navigation to finish...
