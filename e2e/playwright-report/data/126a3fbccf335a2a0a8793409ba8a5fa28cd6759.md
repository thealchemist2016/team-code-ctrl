...
- Name: release.spec.js >> Release Management & User Operations (Tiers 1-4) >> T2-15: Click a track opens details and updates state
- Location: tests\release.spec.js:303:3
...
Locator:  locator('#current-track')
Expected: "Drop It Like It's Hot"
Received: "No Track Playing"
Timeout:  5000ms

Call log:
  - Expect "toHaveText" with timeout 5000ms
  - waiting for locator('#current-track')
    14 × locator resolved to <span id="current-track">No Track Playing</span>
       - unexpected value "No Track Playing"
